...
/*   Updated: 2025/12/27 18:52:56 by rdinis           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	is_lefttop_wall(t_data img, t_vars vars, int x, int y)
{
	...
	if (y == 0 && x == 0)
		return (left_top(img, vars, x * 31, y * 31));
...
void	is_leftbottom_wall(t_data img, t_vars vars, int x, int y)
{
	...
	if (y == vars.height - 1 && x == 0)
		return (left_bottom(img, vars, x * 31, y * 31));
	if (x == 0 || x == ft_strlen(vars.map[0]))
		return ;
	if (y == 0 || y == vars.height - 1)
		return ;
...
void	is_righttop_wall(t_data img, t_vars vars, int x, int y)
{
	...
	if (y == 0 && x == ft_strlen(vars.map[0]) - 1)
		return (right_top(img, vars, x * 31, y * 31));
	if (x == 0 || x == ft_strlen(vars.map[0]))
		return ;
	if (y == 0 || y == vars.height - 1)
		return ;
...
void	is_rightbottom_wall(t_data img, t_vars vars, int x, int y)
{
	...
	if (y == vars.height - 1 && x == ft_strlen(vars.map[0]) - 1)
		return (right_bottom(img, vars, x * 31, y * 31));
	if (x == 0 || x == ft_strlen(vars.map[0]))
		return ;
	if (y == 0 || y == vars.height - 1)
		return ;
